...
<head>
	<!--[if lt IE 9]><script src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/js/html5shiv.min.js"></script><![endif]-->
						...
						<section id="content-section">
							...
							<div class="row-fluid">
								...
								<div class="subtitle">
									...
									<p>
										Se você está certo que o endereço informado está correto mas está encontrando um erro, por favor entre em <a href="<?php echo $this->baseurl; ?>/index.php/contato">contato</a>.</p>
									<p>Obrigado.</p>
								</div>
								<br />
