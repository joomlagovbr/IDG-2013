...
<div id="gallery-carousel-<?php echo $field->id; ?>" class="carousel gallery slide">
	<div class="carousel-inner">
		<?php foreach ($values as $value) : ?>
			<div class="item<?php echo $valuesCounter == 0 ? ' active' : ''; ?>">
				...
				<img src="<?php echo $value['Foto']; ?>" alt="<?php echo $altText; ?>" />
				<div class="carousel-caption">
					...
					<?php if ($value['Autor']) : ?>
						<p class="rights">Foto: <?php echo $value['Autor']; ?></p>
					<?php endif; ?>
	...
	<?php if ($valuesCounter > 1) : ?>
		<a class="carousel-control left" href="#gallery-carousel-<?php echo $field->id; ?>" data-slide="prev">&lsaquo;</a>
		<a class="carousel-control right" href="#gallery-carousel-<?php echo $field->id; ?>" data-slide="next">&rsaquo;</a>
	<?php endif; ?>
</div>
