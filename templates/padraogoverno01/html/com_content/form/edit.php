...
<div class="edit item-page<?php echo $this->pageclass_sfx; ?>">
	<span class="documentCategory">Edi&ccedil;&atilde;o de conte&uacute;do</span>
		...
		<fieldset>
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="publishing">
					...
					<?php endif; ?>
					<br /><br /><br /><br /><br /><!--insercao de espacos para evitar problemas relacionados à ocultacao de campos-->
				</div>
