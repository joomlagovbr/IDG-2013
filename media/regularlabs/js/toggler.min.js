...
"select"}else type=el.type;var func=function(){self.toggle(el_name)};switch(type){case "radio":case "checkbox":$(el).bind("click",func).bind("keyup",func);break;case "select":case "select-one":case "text":case "textarea":$(el).bind("change",func).bind("keyup",func);break;default:$(el).bind("change",func);break}$(el).attr("togglerEventAdded",1)}}})(jQuery);
