...
el.style.opacity==0)el.style.opacity=1;(function fade(){el.style.opacity=parseFloat(el.style.opacity)-change;if(el.style.opacity<=0){self.hide(el);if(oncomplete)oncomplete.call();return}setTimeout(function(){fade.call()},wait)})()}};