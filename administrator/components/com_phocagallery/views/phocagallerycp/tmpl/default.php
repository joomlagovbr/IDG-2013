...
<div class="pga-cpanel-right">
	<div class="well">
            ...
            <?php echo '<div class="ph-cpanel-logo">'.JHtml::_('image', 'media/com_phocagallery/images/administrator/logo-phoca-gallery.png', 'Phoca.cz') . '</div>'; ?>
            <div style="float:right;margin:10px;"><?php echo JHTML::_('image', 'media/com_phocagallery/images/administrator/logo-phoca.png', 'Phoca.cz' );?></div>
