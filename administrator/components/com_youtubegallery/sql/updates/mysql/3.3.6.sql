...
ALTER TABLE #__youtubegallery_videos ADD COLUMN dislikesint(11) NOT NULL default 0;
ALTER TABLE #__youtubegallery_videos ADD COLUMN commentcountint(11) NOT NULL default 0;
