 ...
 * @license		GNU General Public License version 2 or later; see LICENSE.txt
 VERSAO MODIFICADA PARA O PORTAL PADRAO, BASEADA NA VERSAO DO JRepeatable DO JOOMLA 3.3.6
 */
...
(function ($) {
    $.JRepeatable = function (elid, names, field, maximum) {
         ...
         * funcao alterada:
            e.target PARA $(e.target)
            getParent() PARA parents()
            get('tag') PARA pro('tagName').toLowerCase()
         */
        findTr = function (e) {
            target = $(e.target);
            var tr = target.parents().filter(function () {
                return $(this).prop('tagName').toLowerCase() === 'tr';
            });
