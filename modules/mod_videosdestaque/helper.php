...
class ModVideosDestaqueHelper
{
	...
	protected static function youtube_player( $url, $qtd_itens )
	{
		...
		$html = '<iframe title="Video" width="100%" height="auto" frameborder="0" allowfullscreen="" src="//www.youtube.com/embed/'. $videoId .'?showinfo=0"></iframe>';
		echo $html;
	}
	...
	protected static function centraldemidia_player( $url, $qtd_itens )
	{
		...
		$html = '<iframe title="Video" width="100%" height="auto" src="'.$url.'" frameborder="0" scrolling="no"></iframe>';
		echo $html;
	}
