				...
				<form action="index.php" method="get" role="search">
					<div class="search">						
						...
						<div class="input-append">
        					...
        					<input type="text" aria-label="Buscar no portal" name="searchword" title="<?php echo JText::_('COM_AGENDADIRIGENTES_TMPL_AUTORIDADE_INPUTSEARCH_TEXT'); ?>" placeholder="<?php echo JText::_('COM_AGENDADIRIGENTES_TMPL_AUTORIDADE_INPUTSEARCH_TEXT'); ?>" class="inputbox searchField" maxlength="20" >       
            				<button class="btn searchButton" type="submit" aria-label="Buscar"><span class="hide"><?php echo JText::_('COM_AGENDADIRIGENTES_TMPL_AUTORIDADE_BTNSEARCH_TEXT'); ?></span><i class="icon-search"></i></button>
						</div>
					</div>
				</form>
			</div>			
