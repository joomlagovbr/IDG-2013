...
echo '<div class="control-label ph-head-form-small">' . JText::_( 'COM_PHOCAGALLERY_UPLOAD_FILE' ).' [ ';

if ($this->tmpl['uploadmaxsizeread'] != '0 B') {
	echo  JText::_( 'COM_PHOCAGALLERY_MAX_SIZE' ).':&nbsp;'.$this->tmpl['uploadmaxsizeread'].','.' ';
}

echo JText::_('COM_PHOCAGALLERY_MAX_RESOLUTION').':&nbsp;'. $this->tmpl['uploadmaxreswidth'].' x '.$this->tmpl['uploadmaxresheight'].' px ]</div>';
